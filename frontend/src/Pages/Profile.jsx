...
const Profile = () => {
  ...
  const fetchUserData = async () => {
    ...
    try {
      ...
      setFormData(res.data.user || {}); // Ensure formData gets populated properly
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.name || !formData.phone || !formData.address.localArea || !formData.address.city || !formData.address.state || !formData.address.pin) {
      ...
      <div className="profile-container">
        ...
        <form className="profile-form" onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <input type="file" name="image" accept="image/*" onChange={handleChange} ref={imageRef} style={{ display: "none" }} />
          </div>
          ...
          <div className="form-group">
            ...
            <input type="tel" name="phone" value={formData.phone || ""} onChange={handleChange} required maxLength={10} placeholder="Enter mobile number" />
          </div>
          ...
          <div className="form-group">
            ...
            <input type="text" name="address.localArea" value={formData.address?.localArea || ""} onChange={handleChange} required />
          </div>
          ...
          <div className="form-group">
            <label>PIN</label>
            <input type="text" name="address.pin" value={formData.address?.pin || ""} onChange={handleChange} maxLength={6} required />
          </div>
